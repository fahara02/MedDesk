...
export function applyDocument(
  ...
  const next: ConsultationInput = {
    ...
    document,
    date: "",
    patient: { ...draft.patient, name: "", age: "", sex: "", reference: "", address: "" },
    clinician: { name: "", registration: "", clinic: "", qualifications: "", designation: "", address: "", phone: "" },
    medications: [],
    manualVitals: {
      bloodPressure: "",
      pulse: "",
...
export function sameProjection(
  ...
  const values = (value: ConsultationInput) => [
    ...
    value.clinician.designation || "",
    value.clinician.address || "",
